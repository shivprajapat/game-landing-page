          ...
          <div className="flex flex-col sm:flex-row sm:justify-center items-center gap-5 w-full sm:w-fit">
            <div className="flex-between w-full sm:w-fit">
              <img
                ...
                alt="game"
                className="max-w-full rounded-md h-24 lg:h-28 sm:mx-auto"
              />
              <div className="bg-yellow-200 p-1 rounded-md block sm:hidden">
                <img
                  ...
                  alt="qr"
                  className="max-w-full rounded-md h-24 lg:h-32 mx-auto"
                />
              </div>
            </div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl text-black text-left font-bold w-full sm:w-fit">
